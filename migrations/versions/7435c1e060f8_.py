...
Revision ID: 7435c1e060f8
Revises: 
Create Date: 2017-08-21 21:19:41.346412
...
def upgrade():
    ...
    sa.Column('scored_points', sa.Float(), nullable=True),
    ...
    sa.Column('completed_at', sa.DateTime(), nullable=True),
    sa.Column('expires_at', sa.DateTime(), nullable=True),
    sa.Column('passing_points', sa.Float(), nullable=True),
